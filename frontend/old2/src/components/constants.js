...
let PREFIX_USERS_CREATE   = "users/create"
let PREFIX_USERS_READ     = "users/read"
let PREFIX_USERS_UPDATE   = "users/update"
let PREFIX_USERS_DELETE   = "users/delete"
...
if (process.env.NODE_ENV != "production"){
    ...
    PREFIX_USERS_CREATE = DEV_URL + path.join("/", PREFIX, "users", "create")
    PREFIX_USERS_READ   = DEV_URL + path.join("/", PREFIX, "users", "read")
    PREFIX_USERS_UPDATE = DEV_URL + path.join("/", PREFIX, "users", "update")
    PREFIX_USERS_DELETE = DEV_URL + path.join("/", PREFIX, "users", "delete")
}
...
export const URL_USERS_CREATE = PREFIX_USERS_CREATE;
export const URL_USERS_READ   = PREFIX_USERS_READ;
export const URL_USERS_UPDATE = PREFIX_USERS_UPDATE;
export const URL_USERS_DELETE = PREFIX_USERS_DELETE;
